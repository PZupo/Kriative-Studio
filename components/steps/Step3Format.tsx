...
const Step3Format: React.FC<Props> = ({ selections, onUpdate, onNext, onBack }) => {
    ...
    return (
        <div className="flex flex-col items-center animate-fade-in">
            <h2 className="text-2xl font-bold text-center mb-6">Escolha o formato do conteúdo:</h2>
            ...
            {selectedFormatConfig && selectedFormatConfig.isVideo && (
                <div className="w-full max-w-sm mt-6 p-4 bg-gray-50 rounded-lg animate-fade-in border border-gray-200">
                    <label htmlFor="duration-slider" className="block text-sm font-medium text-gray-700 mb-2">
                        Duração do Vídeo: <span className="font-bold text-[#008080]">{selections.duration || currentMaxDuration}s</span>
                    </label>
                    <input
                        id="duration-slider"
                        type="range"
